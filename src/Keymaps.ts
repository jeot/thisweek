...
export const KEYMAPS = [
  ...
  { mode: "N", mod: "", keys: "ArrowRight", action: Action.gotoNextTimePeriod, desc: "Go to Next Week/Year" },
  { mode: "N", mod: "", keys: "ArrowLeft", action: Action.gotoPreviousTimePeriod, desc: "Go to Previous Week/Year" },
  ...
  { mode: "N", mod: "", keys: "W", action: Action.gotoNextWeek, desc: "Go to Next Week" },
  { mode: "N", mod: "Shift", keys: "W", action: Action.gotoPreviousWeek, desc: "Go to Previous Week" },
  { mode: "N", mod: "", keys: "T", action: Action.gotoCurrentTimePeriod, desc: "Go to Today's Week/Year" },
  { mode: "N", mod: "", keys: "O", action: Action.displayObjectivesPage, desc: "Display Years (Objectives)" },
  { mode: "N", mod: "", keys: "S", action: Action.switchYearsCalendar, desc: "Switch Calendar Type of Years (Objectives)" },
  ...
  { mode: "N", mod: "", keys: "L", action: Action.gotoNextTimePeriod, desc: "Go to Next Week/Year" },
  { mode: "N", mod: "", keys: "H", action: Action.gotoPreviousTimePeriod, desc: "Go to Previous Week/Year" },
